...
const absentVowel = str => {
    // show me the vowels
    // for each vowel, ask => hello string, are you missing this vowel? if so, return the index of this vowel, otherwise move on
    const vowels = 'aeiou'
    // normalize string anyways just in case
