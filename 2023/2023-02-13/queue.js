...
// create a class for Queue (LIFO) 
// give it the methods enqueue (push an item to the end of the queue) and dequeue (shift the first item off the stack)
...
// using objects for improved efficiency (shift requires each element of the array to move over)
// instead we keep track of the head and tail
...
console.log(queue, "add banana")
queue.enqueue('strawberry')
console.log(queue, "add strawberry")
queue.enqueue('apple')
console.log(queue, "add apple")
queue.dequeue()
console.log(queue, "dequeue: banana")
queue.dequeue()
console.log(queue, "dequeue: strawberry")