...
const greatestCommonDivisor = (x, y) => {
    // find the smaller number (this could be the greatest common divisor)
    // count down
...
const greatestCommonDivisor2 = (x, y) => {
    // euclidean algorithm says that gcd(x, y) = gcd(q, r) where q = quotient (i.e., y), and remainder is x % y
