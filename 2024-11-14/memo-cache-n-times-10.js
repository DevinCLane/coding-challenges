...
console.log("~~~task 3~~~");
const closureTimes10 = memoTimes10;

console.log("task 3 calculated value: ", closureTimes10(9)); // calculated
console.log("task 3 cached value: ", closureTimes10(9)); // cached
