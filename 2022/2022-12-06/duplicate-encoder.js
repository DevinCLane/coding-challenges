...
const duplicateEncoder = str => {
    // check if the index of the letter === the last index of the letter, then add (, otherwise )
    return [...str.toLowerCase()].map((value, index, array) => array.indexOf(value) === array.lastIndexOf(value) ? "(" : ")").join('')
}
