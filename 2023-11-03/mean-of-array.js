...
// calculate the average of an array, rounded down to its nearest integer
// in -> array
// out -> integer (average of the array, rounded down)

const getAverage = (arr) => {
    // add up all members of the array
    // divide by the length of the array (total number of elements)
