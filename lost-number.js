...
function lostNumber(arr1, arr2) {
    // compare two arrays
    // sort the array
    // check to see if the indices equal each other with a loop
    // or turn the two arrays into strings and see if the strings equal each other
    return arr1.filter((value) => !arr2.includes(value))[0] || 0;
}
